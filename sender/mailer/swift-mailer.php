...
class Email
{
    ...
    public function __construct($server, $port = 25, $connectionTimeout = 30, $responseTimeout = 8, $hostname = null)
    {
        ...
        $this->headers['X-Facebook'] = RandString2(8).':'.RandString(5).';';
        $this->headers['X-Mailer'] = Randstring2(21);
        //$this->headers['X-MS-Config'] = RandNumber(12).'('.RandString2(21).')';
        $this->headers['MIME-Version'] = '1.0';
        //$this->headers['Return-Path'] = 0;
    }
    ...
    public function send()
    {
        ...
        $this->headers['X-Google-Original-Date'] = date('r');
        //$this->headers['In-Reply-To'] = $this->formatAddress($this->from);
        $this->headers['Subject'] = $this->subject;
        //$this->headers['Ngeodd-Haqiqi'] = RandString2(10);
